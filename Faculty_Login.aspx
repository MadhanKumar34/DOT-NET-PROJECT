<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faculty_Login.aspx.cs" Inherits="Project_2.Faculty_Login" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div>
                ...
                <asp:HyperLink ID="hlRegister" runat="server" NavigateUrl="faculty_register.aspx" Text="Register" CssClass="additional-link" />
                &nbsp&nbsp&nbsp&nbsp<asp:HyperLink ID="hlForgotPassword" runat="server" NavigateUrl="Faculty_FPassword.aspx" Text="Forgot Password?" CssClass="additional-link" />
