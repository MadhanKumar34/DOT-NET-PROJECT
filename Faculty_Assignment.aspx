<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faculty_Assignment.aspx.cs" Inherits="Project_2.Faculty_Assignment" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <main>
        <div class="container">
            <h1>Assignment Details</h1><br /><br />
            <asp:Label ID="lblMessage" runat="server" ForeColor="Red"></asp:Label>
            <div class="form-group">
                <label>Subject</label>
                <asp:TextBox ID="Subject" runat="server" CssClass="form-control" required/></div>
            <div class="form-group">
                <label>Topic</label>
                <asp:TextBox ID="Topic" runat="server" CssClass="form-control" required/>
            </div>
            <div class="form-group">
                <label>DueDate</label>
                <asp:TextBox ID="DueDate" runat="server" CssClass="form-control" required/>
            </div>
            <div>
