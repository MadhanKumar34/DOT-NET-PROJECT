<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faculty_Update.aspx.cs" Inherits="Project_2.Faculty_Update" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="university-logo">
            ...
            <h2>Faculty Details Updation Page</h2>
    </header>
        <main>
        <div class="container">
            <br />
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="Password" runat="server" CssClass="form-control" required/>
            </div>
            <div>
                <asp:Button ID="btnLogin" runat="server" Text="Update" OnClick="Submit_Click" CssClass="btn-login" /><br />
